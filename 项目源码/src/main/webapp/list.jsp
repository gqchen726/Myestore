...
<c:forEach var="book" items="${applicationScope.books }" >
        <div class="c4_b2">
            <h1 class="c4_b2_x">
                ...
                <span><a href="#">${book.description }</a></span>
            </h1>
            	...
            	<ul class="c4_b5_c_boxes">
                		...
                		<li class="c4_b5_c_box">
	                    	...
	                    	<div class="c4_b5_c_box_pic">
	                        	...
	                        	<!-- http://127.0.0.1:9999/JD03_estory/view?id=1 
	                        	/JD03_estore -->
	                            	<a href="/JD03_estore/view?id=${book.id }"><img src="images/list_p1.png"></a>
	                            </div>
	                        </div>
	                        <!--价钱-->
	                        <div class="c4_b5_c_box_txt">
	                        	<h1>${book.price }</h1>
	                            <h2><a href="/JD03_estory/view?id=${book.id }">${book.name }</a></h2>
	                        </div>
	                        <!--购买等操作-->
	                        <div class="c4b5_el">
	                        	<div class="c4b5_el_x">
