...
<body>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="/JD03_estore/"><img src="images/logo.png"  class="oneImg"></a>
    ...
    <div class="content">
		...
		<form action="/JD03_estore/addOrder" name="orderForm" method="post">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
					<c:forEach var="address" items="${sessionScope.addresses }">
			    		<li>
			    			<input type="radio" name="addrId" style="width:50px" checked="checked" value="${address.id }">
			    			收货人姓名:${address.receivename }&nbsp;&nbsp;&nbsp;收货人电话:${address.phone }&nbsp;&nbsp;&nbsp;收货地址:${address.address }
			    		</li>
					</c:forEach>
    			...
    			<p id="newAdres" style="font-size:15px;display: none;">
					...
					<input width="30px" type="submit" value="添加" name="addAddress" >
				</p>
    		</div>
    		...
    		<div class="bigDiv">
    			<div class="twoDiv">
    				<b>商家：briup自营</b>
    					<c:forEach var="line" items="${sessionScope.car.lines }">
							<ul class="oneUL">
		    					<li>
		    						<img src="images/viewBook.png" class="pic">
		    						<p>${line.book.description }&nbsp;&nbsp;${line.book.description }&nbsp;&nbsp;${line.book.name }&nbsp;&nbsp;</p>
		    						<p><font>¥${line.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span><font>${sessionScope.car.size }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.car.cost }</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.car.cost }</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${sessionScope.car.cost }</font><input type="image" src="images/21_03.png"></span>
    		</div>
			</form>
    	</div>
